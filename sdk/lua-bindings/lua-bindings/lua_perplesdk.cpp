...
int tolua_PerpleSDK_setFCMPushOnForeground(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
    tolua_Error tolua_err;
    if (!tolua_isusertable(tolua_S, 1, "PerpleSDK", 0, &tolua_err) ||
...
#endif
    {
        int isReceive = (int)tolua_tonumber(tolua_S, 2, 0);

        jniFuncV_I("setFCMPushOnForeground", -1, isReceive);
...
#ifndef TOLUA_RELEASE
tolua_lerror :
    tolua_error(tolua_S, "PerpleSDKLua: Error in function 'setFCMPushOnForeground'.", &tolua_err);
    return 0;
#endif
}
...
int tolua_PerpleSDK_tapjoySetTrackPurchase(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
    tolua_Error tolua_err;
    if (!tolua_isusertable(tolua_S, 1, "PerpleSDK", 0, &tolua_err) ||
...
#ifndef TOLUA_RELEASE
tolua_lerror :
    tolua_error(tolua_S, "PerpleSDKLua: Error in function 'tapjoySetTrackPurchase'.", &tolua_err);
    return 0;
#endif
}
...
#endif
    {
        int isDeleteToken = (int)tolua_tonumber(tolua_S, 2, 0);

        jniFuncV_I("naverLogout", -1, isDeleteToken);
...
#endif
    {
        int tapNumber = (int)tolua_tonumber(tolua_S, 2, 0);

        jniFuncV_I("naverCafeStart", -1, tapNumber);
...
#endif
    {
        int isUseVideoRecord = (int)tolua_tonumber(tolua_S, 2, 0);

        jniFuncV_I("naverCafeSetUseVideoRecord", -1, isUseVideoRecord);
...
#endif
    {
        const char* checkReceiptServerUrl = tolua_tostring(tolua_S, 2, 0);
        int funcID = toluafix_ref_function(tolua_S, 3, 0);

        jniFuncV_S("setBilling", funcID, checkReceiptServerUrl);
...
int registerAllPerpleSdk(lua_State* L)
{
    ...
    tolua_beginmodule(L, NULL);
        ...
        tolua_beginmodule(L,"PerpleSDK");
            ...
            tolua_function(L, "setFCMPushOnForeground", tolua_PerpleSDK_setFCMPushOnForeground);
            ...
            tolua_function(L, "tapjoySetTrackPurchase", tolua_PerpleSDK_tapjoySetTrackPurchase);
