...
IMPL_LUABINDING_FUNC_V_V(loginGoogle)
IMPL_LUABINDING_FUNC_V_V(loginFacebook)
IMPL_LUABINDING_FUNC_V_SS(loginEmail)
...
int registerAllPerpleSdk(lua_State* L)
{
    ...
    tolua_beginmodule(L, NULL);
        ...
        tolua_beginmodule(L,"PerpleSDK");
            ...
            DECL_LUABINDING_FUNC(loginGoogle)
            DECL_LUABINDING_FUNC(loginFacebook)
            DECL_LUABINDING_FUNC(loginEmail)
